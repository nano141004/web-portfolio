...
const experiences = [
  ...
  },
  {
    ...
    description:
      ● Staff of Catholic Student Body Organization for Fakultas Ilmu Komputer (Fasilkom) UI ● Participated in strengthening the bond between members of KMK Fasilkom UI by keeping birthday records and delivering
personalized birthday greetings to each memberogies.",
