    ...
    projects: [
      {
        ...
        description:
          "Developed a fully supervised module based on  to detect synthetic speech segments using Wav2Vec2 features. Achieved 0.79% EER for utterance detection. Research highlighted trade-offs in temporal resolution, with frame-level localization yielding 17.34% EER.",
