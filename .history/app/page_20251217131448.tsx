      ...
      <section id="about" className="py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-5xl mx-auto">
            A Computer Science undergraduate dedicated to AI research, currently exploring Natural Language Processing and Deep Learning. I have hands-on experience across various domains, including Computer Vision and AudioProcessing—leveraging strong analytical skills to solve complex problems and conduct meaningful research. solutions.
          </p>
