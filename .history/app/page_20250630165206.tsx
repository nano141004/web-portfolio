  ...
  "data-science": {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Built a model to predict customer subscription to deposit products. Used EDA, feature engineering, and trained various models including stacking. Achieved 0.7897 AUC, close to top 3 scores (0.794).",
