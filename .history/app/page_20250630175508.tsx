      ...
      <section id="about" className="py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-5xl mx-auto">
            A Computer Science undergraduate student, passionate about Data Science, backed by hands-on experience in multiple projects involving machine learning, data analysis, and software development. Strong in problem solving, armed with coding skills and analytical thinking to deliver effective data-driven solutions.
          </p>
