...
const experiences = [
  {
    ...
    description:
      "● Collaborated in a team of three to develop the back-end system for the official UI Battlegrounds 2024 website" + "\n" + "● Designed a scalable UML Class Diagram to support future system expansion and maintainabilitytions.",
