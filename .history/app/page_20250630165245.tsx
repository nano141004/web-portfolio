  ...
  "data-science": {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Predicted citation links between academic papers in a team of three. Preprocessed text and extracted features using TF-IDF and metadata. Trained binary classifiers and achieved an MCC score .",
