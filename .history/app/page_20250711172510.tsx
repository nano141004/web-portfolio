  ...
  "data-science": {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Developed a Power BI dashboard to analyze e-commerce customer behavior using a public dataset. 
Transformed raw data into actionable insights by creating KPIs and performing aggregations. Visualized trends in sales, customer segments, and promotional effectiveness to support business decision-making.",
