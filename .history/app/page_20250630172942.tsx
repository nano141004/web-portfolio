...
const skills = [
  { category: "Programming Languages", items: ["Python", "SQL", "Java", "Godot", "JavaScript"] },
  { category: "Data Science & ML Libraries, Tools", items: ["Scikit-learn", "TensorFlow", "PyTorch", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Jupyter"] },
  { category: "Software Development Tech ", items: ["React", "Next.js", "Node.js", "FastAPI", "Django"] },
